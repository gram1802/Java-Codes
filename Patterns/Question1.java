...
public static void main(String []args){
    ...
    for(int i=0; i<n; i++){
        for(int j=0; j<n; j++){
            if(j==0 && i<(n-1)/2 || i==0 && j<(n-1)/2 || j==(n-1)/2 && i!=0 && i<(n-1)/2 || i==(n-1)/2 && j<(n-1)/2){
                System.out.print("*");
            }
            else{
                System.out.print(" ");
    ...
    for(int i=0; i<n; i++){
        for(int j=0; j<n; j++){
            if(j==0 && i<(n-1)/2 || i==0 && j<(n-1)/2 || i==(n-1)/2 && j<(n-1)/2 || i==(n-1)/4 && j<(n-1)/2){
                System.out.print("*");
            }
            else{
                System.out.print(" ");
    ...
    for(int i=0; i<n; i++){
        for(int j=0; j<n; j++){
            if(j==0 && i<(n-1)/2 || i==0 && j<(n-1)/2 || i==(n-1)/4 && j<(n-1)/2){
                System.out.print("*");
            }
            else{
                System.out.print(" ");
    ...
    for(int i=0; i<n; i++){
        for(int j=0; j<n; j++){
            if(j==0 && i<(n-1)/2 || i==(n-1)/2 && j<(n-1)/2 || j==(n-1)/2 && i>(n-1)/4 && i<(n-1)/2 || i==(n-1)/4 && j>=(n-1)/4 
            && j<=(n-1)/2 || i==0 && j<(n-1)/2){
                System.out.print("*");
            }
            else{
